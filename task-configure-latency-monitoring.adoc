...
如果您尚未配置 AWS 凭据，请参阅 link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["添加 AWS 凭据"^]。
...
要查看创建和关联链接的说明，请参阅 link:https://docs.netapp.com/us-en/workload-fsx-ontap/create-link.html["创建链接"^]。
...
如果您的账号管理员已关闭 AI 功能，您将看到一条消息，无法使用 AI 分析功能。请联系管理员或参阅 link:https://docs.netapp.com/us-en/workload-setup-admin/manage-genai-features.html["了解人工智能管理"^]。
...
要启用通知，请参阅 link:https://docs.netapp.com/us-en/workload-setup-admin/configure-notifications.html#wf-console-email-notifications["配置通知设置"]。
